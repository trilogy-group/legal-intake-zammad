...
const schema = markRaw([
  {
    ...
    children: [
      ...
      },
      {
        ...
        help: __('You can always send your feedback using the button next to the BETA switch.'),
        sectionsSchema: {
          help: {
            if: 'true',
            children: {
...
const close = () => closeDialog(FEEDBACK_DIALOG_NAME, true)
...
const submitFeedback = async (data: FeedbackFormData) => {
  const timeSpendInMinutes = appUsage.totalAppUsageTime / 60_000 // milliseconds to minutes
