...
<template>
  <CommonActionMenu
    :class="{
      'rounded-md p-2 hover:outline hover:outline-blue-900! has-focus-visible:outline has-focus-visible:outline-offset-0! has-focus-visible:outline-blue-800! has-focus-visible:*:outline-none':
        menuItems.length === 1,
    }"
