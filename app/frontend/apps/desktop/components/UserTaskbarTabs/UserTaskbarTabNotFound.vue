...
<template>
  <CommonLink
    ...
    class="focus-visible-app-default grow flex items-center gap-2 px-2 py-3 group-hover/tab:bg-blue-600 hover:no-underline! focus-visible:rounded-md group-hover/tab:dark:bg-blue-900"
    :class="{
