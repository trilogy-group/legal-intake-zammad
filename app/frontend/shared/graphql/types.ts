...
export type TicketAiAssistanceSummarizePayload = {
  ...
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
  /** MD5 digest of the complete summary content */
