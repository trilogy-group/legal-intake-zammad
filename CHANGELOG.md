# Change Log for Zammad 7.0.0

- [Release notes](https://zammad.com/en/releases/7-0)
...
- [Full commit log](https://github.com/zammad/zammad/compare/6.5.2...7.0.0)
- [File tree](https://github.com/zammad/zammad/tree/7.0.0)
