# Change Log for Zammad 7.0.1

- [Release notes](https://zammad.com/en/releases/7-0-1)
...
- [Full commit log](https://github.com/zammad/zammad/compare/7.0.0...7.0.1)
- [File tree](https://github.com/zammad/zammad/tree/7.0.1)
