...
RSpec.describe Gql::Queries::Tickets::Stats::MonthlyByOrganization, :aggregate_failures, type: :graphql do
  let(:query) do
    <<~QUERY
  ...
  let(:variables)        { { organizationId: gql.id(customer_ticket.organization) } }
